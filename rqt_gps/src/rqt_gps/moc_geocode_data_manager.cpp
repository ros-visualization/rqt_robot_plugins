...
**
** Created: Fri Mar 15 13:45:06 2013
...
static const char qt_meta_stringdata_GeocodeDataManager[] = {
    "GeocodeDataManager\0\0errorOccured(QString)\0"
    "east,north\0coordinatesReady(double,double)\0"
...
const QMetaObjectExtraData GeocodeDataManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GeocodeDataManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GeocodeDataManager,
      qt_meta_data_GeocodeDataManager, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GeocodeDataManager::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GeocodeDataManager))
